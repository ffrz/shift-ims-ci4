    ...
    <div class="card-body">
        <div class="tab-content" id="customer-tabContent">
            <div class="tab-pane fade show active table-responsive" id="tabcontent1" role="tabpanel" aria-labelledby="tabcontent1-tab1">
                ...
                <div class="mt-3">
                    <form method="post" action="<?= base_url("sales-orders/fully-paid/$data->id") ?>">
                        <?= csrf_field() ?>
                        <div class="btn-group">
                            <a href="<?= base_url("sales-orders/view/$data->id?print=1") ?>" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print mr-1"></i> Print</a>
